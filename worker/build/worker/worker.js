...
var storeUsers = function (job, users) { return __awaiter(void 0, void 0, void 0, function () {
    var total, response, syncId, processed, _i, users_1, u, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                total = users.length;
            ...
            case 2:
                user = _a.sent();
                try {
                    userService_1.updateUser(user);
                }
                catch (error) {
                    if (error.message == "User with email " + u.email + " does not exist") {
                        userService_1.createUser(user);
                    }
                    else {
                ...
                processed++;
                job.reportProgress({ processed: processed, total: total });
                _a.label = 3;
            case 3:
                _i++;
                return [3, 1];
            case 4: return [2, Promise.resolve(response)];
        }
    });
}); };
